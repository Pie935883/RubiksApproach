...
<img src="https://yuml.me/diagram/usecase/draw/[utente]>(avvia app),(avvia app)>(inserisce credenziali),[sistema]-(verifica credenziali),(verifica credenziali)>(autorizza accesso),(inserisce credenziali)<(logout),(inserisce credenziali)<(accesso area riservata),(verifica credenziali)>(gestione errori di accesso),(gestione errori di accesso)<(recupero password)">
